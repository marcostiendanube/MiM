...
data_dir <- '/mnt/c/Users/Marcos/Documents/MiM/code/MiM/mineria_de_datos/tp1/data'
script_dir <- '/mnt/c/Users/Marcos/OneDrive - Tienda Nube/MiM/Mineria de Datos/tp/tp1/script'
...
#write.table(xgbFit$results[which.max(xgbFit$results$ROC),], paste(data_dir,'/model_',format(Sys.time(), "%Y%m%d%H%M%S"),'.txt', sep = ''), sep=",")
#Save variables importance plot to image
